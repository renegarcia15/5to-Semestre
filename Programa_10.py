...
print("Porcentaje de personas que vivos ---> {porcentaje_vivos:.2f}%")
print("Porcentaje de personas que muertos---> {porcentaje_muertos:.2f}%")

porcentaje_vivos_clase = james_cameron.groupby('Pclass')['Survived'].mean() * 100
print("Porcentaje de personas que vivos en cada clase---> \n",porcentaje_vivos_clase)
